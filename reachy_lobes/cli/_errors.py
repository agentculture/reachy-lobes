...
Every failure inside reachy-lobes raises :class:`CliError`. The
top-level ``main()`` catches it, formats via :mod:`reachy_lobes.cli._output`,
...
# Exit-code policy. Documented in ``reachy-lobes learn`` output.
# 0      = success
