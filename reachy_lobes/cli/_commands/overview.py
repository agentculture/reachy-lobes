"""``reachy-lobes overview`` — read-only descriptive snapshot of the agent.
...
:mod:`reachy_lobes.cli._commands.cli`).
...
from reachy_lobes.cli._commands.whoami import report
