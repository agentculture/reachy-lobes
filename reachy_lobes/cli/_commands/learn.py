"""``reachy-lobes learn`` — the learnability affordance.
...
from reachy_lobes.cli._output import emit_result

_TEXT = """\
reachy-lobes — a clonable template for AgentCulture mesh agents.
...
Commands
--------
  reachy-lobes whoami             Identity from culture.yaml.
  reachy-lobes learn              This self-teaching prompt.
  reachy-lobes explain <path>...  Markdown docs for any noun/verb path.
  reachy-lobes overview           Descriptive snapshot of the agent.
  reachy-lobes doctor             Check the agent-identity invariants.
  reachy-lobes cli overview       Describe the CLI surface itself.
...
def _as_json_payload() -> dict[str, object]:
    return {
        ...
        "json_support": True,
        "explain_pointer": "reachy-lobes explain <path>",
    }
