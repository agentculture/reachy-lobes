...
Every failure inside reachy-mini-cli raises :class:`CliError`. The
top-level ``main()`` catches it, formats via :mod:`reachy.cli._output`,
...
# Exit-code policy. Documented in ``reachy-mini-cli learn`` output.
# 0      = success
